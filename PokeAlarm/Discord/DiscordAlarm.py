...
class DiscordAlarm(Alarm):
    ...
    _defaults = {
        'pokemon': {
            'username': "<pkmn>",
            'content':"",
            'icon_url': "https://github.com/CalamityJames/PokeAlarm/tree/master/icons/<pkmn_id>.png",
            'avatar_url': "https://github.com/CalamityJames/PokeAlarm/tree/master/icons/<pkmn_id>.png",
